 ...
 * @LastEditTime: 2024-07-22 15:56:19
  ...
  methods: {
    ...
    async submitFile() {
      ...
      try {
        const response = await axios.post(
          "http://10.137.118.157:8000/route/upload_lon/",
          formData,
          {
            headers: {
    ...
    async calculateData() {
      ...
      try {
        ...
        const response = await axios.post(
          "http://10.137.118.157:8000/route/calculate_lon/",
          formData,
          {
            headers: {
              "Content-Type": "multipart/form-data",
    ...
    async updateChart() {
      ...
      try {
        const response = await axios.post(
          "http://10.137.118.157:8000/route/recalculate_lon/",
          recalculationData,
          {
            headers: {
